  ...
  if (typeof window !== "undefined") {
    ...
    if (SpeechRecognition && !recognition.current) {
      ...
      recognition.current.onend = () => {
        setIsListening(false);
        input.current.placeholder = "Type or speak your feelings, my love...";
      };
    }
  }
      ...
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
        ...
        <div className="flex items-center gap-2 pointer-events-auto max-w-screen-sm w-full mx-auto">
          <input
            ...
            placeholder="Type or speak your feelings, my love..."
            ref={input}
            onKeyDown={(e) => {
          ...
          <button
            onClick={toggleMic}
            className={`pointer-events-auto bg-pink-500 hover:bg-pink-600 text-white p-4 rounded-md ${isListening ? "bg-pink-600" : ""}`}
